...
export const roTranslations: DefaultTranslationsObject = {
  ...
  general: {
    ...
    uploading: 'Încărcare ({{progress}}%)',
    uploadingBulk: 'Încărcare {{current}} din {{total}} ({{progress}}%)',
    user: 'Utilizator',
    username: 'Nume de utilizator',
    users: 'Utilizatori',
    value: 'Valoare',
  ...
  upload: {
    addFile: 'Adaugă fișier media',
    addFiles: 'Adaugă fișier media',
    bulkUpload: 'Încărcare în masă',
    crop: 'Cultură',
    cropToolDescription:
      'Trageți colțurile zonei selectate, desenați o nouă zonă sau ajustați valorile de mai jos.',
    download: 'Descărcare',
    dragAndDrop: 'Glisează și plasează fișier media',
    dragAndDropHere: 'sau glisează și plasează fișier media aici',
    editImage: 'Editează imaginea',
    fileName: 'Numele fișierului',
    fileSize: 'Dimensiunea fișierului',
    filesToUpload: 'Fișiere media de încărcat',
    fileToUpload: 'Fișiere media de încărcat',
