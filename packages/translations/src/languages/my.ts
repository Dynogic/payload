...
export const myTranslations: DefaultTranslationsObject = {
  ...
  upload: {
    addFile: 'မီဒီယာ ထည့်ပါ',
    addFiles: 'မီဒီယာ ထည့်ပါ',
    ...
    dragAndDrop: 'မီဒီယာကို ဆွဲချပါ',
    dragAndDropHere: 'သို့မဟုတ် မီဒီယာကို ဤနေရာတွင် ဆွဲချပါ',
    editImage: 'ပုံပြင်ပြောင်းရန်',
    fileName: 'ဖိုင် နာမည်',
    fileSize: 'ဖိုင် အရွယ်အစား',
    filesToUpload: 'တင်ရန် မီဒီယာ',
    fileToUpload: 'တင်ရန် မီဒီယာ',
