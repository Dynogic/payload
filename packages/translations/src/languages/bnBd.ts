...
export const bnBdTranslations: DefaultTranslationsObject = {
  ...
  general: {
    ...
    uploading: 'আপলোড করা হচ্ছে ({{progress}}%)',
    uploadingBulk: '{{total}} এর মধ্যে {{current}} আপলোড করা হচ্ছে ({{progress}}%)',
    user: 'ব্যবহারকারী',
    username: 'ব্যবহারকারীর নাম',
    users: 'ব্যবহারকারীরা',
    value: 'মান',
