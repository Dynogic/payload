...
export const thTranslations: DefaultTranslationsObject = {
  ...
  folder: {
    assign: 'กำหนด',
    assignFolder: 'กำหนดโฟลเดอร์',
    assigning: 'กำลังกำหนด...',
    assignItemsToFolderConfirmation:
      'คุณกำลังจะกำหนด <1>{{count}} {{label}}</1> ไปยัง <2>{{toFolder}}</2> คุณแน่ใจหรือไม่?',
    assignItemsToRootConfirmation:
      'คุณกำลังจะลบ <1>{{count}} {{label}}</1> ออกจากโฟลเดอร์ปัจจุบัน คุณแน่ใจหรือไม่?',
    ...
    itemsAssignedToFolder: '{{title}} ถูกกำหนดไปยัง {{folderName}}',
    itemsMovedToFolder: '{{title}} ถูกย้ายไปยัง {{folderName}}',
    itemsMovedToRoot: '{{title}} ถูกย้ายไปยังโฟลเดอร์ราก',
    itemsRemovedFromFolder: '{{title}} ถูกลบออกจากโฟลเดอร์',
  ...
  general: {
    ...
    uploadingBulk: 'อัปโหลด {{current}} จาก {{total}} ({{progress}}%)',
    user: 'ผู้ใช้',
    username: 'ชื่อผู้ใช้',
    users: 'ผู้ใช้',
    value: 'ค่า',
  ...
  upload: {
    ...
    download: 'ดาวน์โหลด',
    dragAndDrop: 'ลากและวางสื่อ',
    dragAndDropHere: 'หรือลากและวางสื่อที่นี่',
    editImage: 'แก้ไขรูปภาพ',
    fileName: 'ชื่อไฟล์',
    fileSize: 'ขนาดไฟล์',
    filesToUpload: 'สื่อที่จะอัปโหลด',
    fileToUpload: 'สื่อที่จะอัปโหลด',
    focalPoint: 'จุดสนใจ',
  ...
  validation: {
    ...
    latitudeOutOfBounds: 'ละติจูดต้องอยู่ระหว่าง -90 และ 90',
