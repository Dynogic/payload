...
export const daTranslations: DefaultTranslationsObject = {
  ...
  general: {
    ...
    uploadingBulk: 'Uploader {{current}} af {{total}} ({{progress}}%)',
    user: 'Bruger',
    username: 'Brugernavn',
    users: 'Brugere',
    value: 'Værdi',
  ...
  upload: {
    addFile: 'Tilføj medie',
    addFiles: 'Tilføj medie',
    bulkUpload: 'Masseupload',
    crop: 'Beskær',
    cropToolDescription:
      'Træk i hjørnerne af det valgte område, tegn et nyt område eller juster værdierne nedenfor.',
    download: 'Download',
    dragAndDrop: 'Træk og slip medie',
    dragAndDropHere: 'eller træk og slip medie her',
    editImage: 'Rediger billede',
    fileName: 'Filnavn',
    fileSize: 'Filstørrelse',
    filesToUpload: 'Medier til upload',
    fileToUpload: 'Medier til upload',
