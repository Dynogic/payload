...
export const ptTranslations: DefaultTranslationsObject = {
  ...
  upload: {
    ...
    addFiles: 'Adicionar mídia',
    bulkUpload: 'Upload em Massa',
    crop: 'Cultura',
    cropToolDescription:
      'Arraste as bordas da área selecionada, desenhe uma nova área ou ajuste os valores abaixo.',
    download: 'Baixar',
    dragAndDrop: 'Arraste e solte a mídia',
    dragAndDropHere: 'ou arraste e solte a mídia aqui',
    editImage: 'Editar imagem',
    fileName: 'Nome do Arquivo',
    fileSize: 'Tamanho do Arquivo',
    filesToUpload: 'Mídia para enviar',
    fileToUpload: 'Mídia para enviar',
  ...
  validation: {
    ...
    invalidBlock: 'O bloco "{{block}}" não é permitido.',
    invalidBlocks: 'Este campo contém blocos que já não são permitidos: {{blocks}}.',
    ...
    latitudeOutOfBounds: 'A latitude deve estar entre -90 e 90.',
