...
export const rsLatinTranslations: DefaultTranslationsObject = {
  ...
  general: {
    ...
    updating: 'Ažuriranje',
    uploading: 'Prenos ({{progress}}%)',
    uploadingBulk: 'Otpremanje {{current}} od {{total}} ({{progress}}%)',
    user: 'Korisnik',
    username: 'Korisničko ime',
    users: 'Korisnici',
    value: 'Vrednost',
  ...
  upload: {
    addFile: 'Dodaj medijum',
    addFiles: 'Dodaj medijum',
    bulkUpload: 'Masovno otpremanje',
    crop: 'Isecite sliku',
    cropToolDescription:
      'Prevucite uglove izabranog područja, nacrtajte novo područje ili prilagodite vrednosti ispod.',
    download: 'Preuzmi',
    dragAndDrop: 'Prevuci i ispusti medijum',
    dragAndDropHere: 'ili prevuci i ispusti medijum ovde',
    editImage: 'Uredi sliku',
    fileName: 'Ime datoteke',
    fileSize: 'Veličina datoteke',
    filesToUpload: 'Mediji za otpremanje',
    fileToUpload: 'Mediji za otpremanje',
