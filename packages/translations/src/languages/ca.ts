...
export const caTranslations: DefaultTranslationsObject = {
  ...
  general: {
    ...
    uploading: 'Pujant ({{progress}}%)',
    uploadingBulk: 'Pujant {{current}} de {{total}} ({{progress}}%)',
    user: 'Usuari',
    username: "Nom d'usuari",
    users: 'Usuaris',
    value: 'Valor',
  ...
  upload: {
    addFile: 'Afegir contingut multimèdia',
    addFiles: 'Afegir contingut multimèdia',
    ...
    download: 'Descarrega',
    dragAndDrop: 'Arrossega i deixa anar contingut multimèdia',
    dragAndDropHere: 'o arrossega i deixa anar contingut multimèdia aquí',
    editImage: 'Editar imatge',
    fileName: 'Nom del fitxer',
    fileSize: 'Mida del fitxer',
    filesToUpload: 'Contingut multimèdia per pujar',
    fileToUpload: 'Contingut multimèdia per pujar',
    ...
    noFile: 'Cap contingut multimèdia',
    ...
    selectFile: 'Seleccioneu contingut multimèdia',
