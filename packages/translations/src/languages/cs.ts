...
export const csTranslations: DefaultTranslationsObject = {
  ...
  general: {
    ...
    uploading: 'Nahrávání ({{progress}}%)',
    uploadingBulk: 'Nahrávání {{current}} z {{total}} ({{progress}}%)',
    user: 'Uživatel',
    username: 'Uživatelské jméno',
    users: 'Uživatelé',
    value: 'Hodnota',
  ...
  upload: {
    addFile: 'Přidat médium',
    addFiles: 'Přidat médium',
    bulkUpload: 'Hromadné nahrání',
    crop: 'Ořez',
    cropToolDescription:
      'Přetáhněte rohy vybrané oblasti, nakreslete novou oblast nebo upravte níže uvedené hodnoty.',
    download: 'Stáhnout',
    dragAndDrop: 'Přetáhněte médium',
    dragAndDropHere: 'nebo přetáhněte médium sem',
    editImage: 'Upravit obrázek',
    fileName: 'Název souboru',
    fileSize: 'Velikost souboru',
    filesToUpload: 'Média k nahrání',
    fileToUpload: 'Média k nahrání',
