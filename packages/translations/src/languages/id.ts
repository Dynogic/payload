...
export const idTranslations: DefaultTranslationsObject = {
  ...
  general: {
    ...
    uploading: 'Mengunggah ({{progress}}%)',
    uploadingBulk: 'Mengunggah {{current}} dari {{total}} ({{progress}}%)',
    user: 'Pengguna',
    username: 'Nama Pengguna',
    users: 'Pengguna',
    value: 'Nilai',
  ...
  upload: {
    addFile: 'Tambahkan media',
    addFiles: 'Tambahkan media',
    bulkUpload: 'Unggah Massal',
    crop: 'Pangkas',
    cropToolDescription:
      'Seret sudut area yang dipilih, gambar area baru atau sesuaikan nilai di bawah ini.',
    download: 'Unduh',
    dragAndDrop: 'Seret dan lepas media',
    dragAndDropHere: 'atau seret dan lepas media di sini',
    editImage: 'Edit Gambar',
    fileName: 'Nama File',
    fileSize: 'Ukuran File',
    filesToUpload: 'Media untuk diunggah',
    fileToUpload: 'Media untuk diunggah',
