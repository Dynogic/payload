...
export const nbTranslations: DefaultTranslationsObject = {
  ...
  folder: {
    assign: 'Tilordne',
    assignFolder: 'Tilordne mappe',
    assigning: 'Tilordner...',
    assignItemsToFolderConfirmation:
      'Du er i ferd med å tilordne <1>{{count}} {{label}}</1> til <2>{{toFolder}}</2>. Er du sikker?',
    assignItemsToRootConfirmation:
      'Du er i ferd med å fjerne <1>{{count}} {{label}}</1> fra deres nåværende mappe. Er du sikker?',
    ...
    itemsAssignedToFolder: '{{title}} tilordnet til {{folderName}}',
  ...
  general: {
    ...
    uploading: 'Opplasting ({{progress}}%)',
    uploadingBulk: 'Laster opp {{current}} av {{total}} ({{progress}}%)',
    user: 'Bruker',
    username: 'Brukernavn',
    users: 'Brukere',
    value: 'Verdi',
  ...
  upload: {
    addFile: 'Legg til medier',
    addFiles: 'Legg til medier',
    bulkUpload: 'Bulk opplasting',
    crop: 'Beskjær',
    cropToolDescription:
      'Dra hjørnene av det valgte området, tegn et nytt område eller juster verdiene nedenfor.',
    download: 'Last ned',
    dragAndDrop: 'Dra og slipp medier',
    dragAndDropHere: 'eller dra og slipp medier her',
    editImage: 'Rediger bilde',
    fileName: 'Filnavn',
    fileSize: 'Filstørrelse',
    filesToUpload: 'Medier å laste opp',
    fileToUpload: 'Medier å laste opp',
