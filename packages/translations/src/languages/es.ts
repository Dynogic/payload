...
export const esTranslations: DefaultTranslationsObject = {
  ...
  upload: {
    addFile: 'Añadir medios',
    addFiles: 'Añadir medios',
    ...
    download: 'Descargar',
    dragAndDrop: 'Arrastrar y soltar medios',
    dragAndDropHere: 'o arrastra y suelta medios aquí',
    editImage: 'Editar imagen',
    fileName: 'Nombre del archivo',
    fileSize: 'Tamaño del archivo',
    filesToUpload: 'Medios para subir',
    fileToUpload: 'Medios para subir',
