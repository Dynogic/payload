...
export const rsTranslations: DefaultTranslationsObject = {
  ...
  upload: {
    addFile: 'Додај медијум',
    addFiles: 'Додај медијум',
    bulkUpload: 'Masovno otpremanje',
    crop: 'Исеците слику',
    cropToolDescription:
      'Превуците углове изабраног подручја, нацртајте ново подручје или прилагодите вредности испод.',
    download: 'Preuzmi',
    dragAndDrop: 'Превуци и испусти медијум',
    dragAndDropHere: 'или превуци и испусти медијум овде',
    editImage: 'Уреди слику',
    fileName: 'Име датотеке',
    fileSize: 'Величина датотеке',
    filesToUpload: 'Медији за отпремање',
    fileToUpload: 'Медији за отпремање',
