...
export const faTranslations: DefaultTranslationsObject = {
  ...
  general: {
    ...
    uploadingBulk: 'در حال آپلود {{current}} از {{total}} ({{progress}}%)',
    user: 'کاربر',
    username: 'نام کاربری',
    users: 'کاربران',
    value: 'مقدار',
  ...
  upload: {
    addFile: 'افزودن رسانه',
    addFiles: 'افزودن رسانه',
    bulkUpload: 'آپلود گروهی',
    crop: 'برش',
    cropToolDescription:
      'گوشه‌های ناحیه انتخاب شده را بکشید، یک ناحیه جدید رسم کنید یا مقادیر زیر را تنظیم نمایید.',
    download: 'دانلود',
    dragAndDrop: 'رسانه را بکشید و رها کنید',
    dragAndDropHere: 'یا رسانه را اینجا بکشید و رها کنید',
    editImage: 'ویرایش تصویر',
    fileName: 'نام فایل',
    fileSize: 'حجم فایل',
    filesToUpload: 'رسانه برای بارگذاری',
    fileToUpload: 'رسانه برای بارگذاری',
