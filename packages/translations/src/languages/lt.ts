...
export const ltTranslations: DefaultTranslationsObject = {
  ...
  upload: {
    addFile: 'Pridėti mediją',
    addFiles: 'Pridėti mediją',
    ...
    download: 'Atsisiųsti',
    dragAndDrop: 'Vilkti ir paleisti mediją',
    dragAndDropHere: 'arba vilkti mediją čia',
    editImage: 'Redaguoti vaizdą',
    fileName: 'Failo pavadinimas',
    fileSize: 'Failo dydis',
    filesToUpload: 'Medija įkelti',
    fileToUpload: 'Medija įkelti',
