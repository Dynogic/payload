...
export const svTranslations: DefaultTranslationsObject = {
  ...
  general: {
    ...
    updating: 'Uppdaterar...',
    uploading: 'Laddar upp... ({{progress}}%)',
    uploadingBulk: 'Laddar upp {{current}} av {{total}} ({{progress}}%)',
    user: 'Användare',
    username: 'Användarnamn',
    users: 'Användare',
    value: 'Värde',
  ...
  upload: {
    addFile: 'Lägg till media',
    addFiles: 'Lägg till media',
    bulkUpload: 'Massuppladdning',
    crop: 'Beskär',
    cropToolDescription:
      'Dra i hörnen på det valda området, rita ett nytt område eller justera värdena nedan.',
    download: 'Ladda ner',
    dragAndDrop: 'Dra och släpp media',
    dragAndDropHere: 'eller dra och släpp media här',
    editImage: 'Redigera bild',
    fileName: 'Filnamn',
    fileSize: 'Filstorlek',
    filesToUpload: 'Media att ladda upp',
    fileToUpload: 'Media att ladda upp',
  ...
  version: {
    ...
    unpublishedSuccessfully: 'Avpublicerat',
    unpublishIn: 'Avpublicera språk: {{locale}}',
