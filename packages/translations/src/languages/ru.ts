...
export const ruTranslations: DefaultTranslationsObject = {
  ...
  general: {
    ...
    uploadingBulk: 'Загрузка {{current}} из {{total}} ({{progress}}%)',
    user: 'пользователь',
    username: 'Имя пользователя',
    users: 'пользователи',
    value: 'Значение',
  ...
  upload: {
    addFile: 'Добавить медиа',
    addFiles: 'Добавить медиа',
    bulkUpload: 'Массовая загрузка',
    crop: 'Обрезать',
    cropToolDescription:
      'Перетащите углы выбранной области, нарисуйте новую область или отрегулируйте значения ниже.',
    download: 'Скачать',
    dragAndDrop: 'Перетащите медиафайл',
    dragAndDropHere: 'или перетащите медиафайл сюда',
    editImage: 'Редактировать изображение',
    fileName: 'Имя файла',
    fileSize: 'Размер файла',
    filesToUpload: 'Медиа для загрузки',
    fileToUpload: 'Медиа для загрузки',
