...
export const trTranslations: DefaultTranslationsObject = {
  ...
  upload: {
    ...
    download: 'İndir',
    dragAndDrop: 'Medyayı sürükleyip bırakın',
    dragAndDropHere: 'veya medyayı buraya sürükleyip bırakın',
    editImage: 'Görüntüyü Düzenle',
    fileName: 'Dosya adı',
    fileSize: 'Dosya boyutu',
    filesToUpload: 'Yüklenecek medya',
    fileToUpload: 'Yüklenecek medya',
