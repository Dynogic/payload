...
export const arTranslations: DefaultTranslationsObject = {
  ...
  general: {
    ...
    uploadingBulk: 'جاري التحميل {{current}} من {{total}} ({{progress}}%)',
    user: 'المستخدم',
    username: 'اسم المستخدم',
    users: 'المستخدمين',
    value: 'القيمة',
  ...
  upload: {
    addFile: 'إضافة وسائط',
    addFiles: 'إضافة وسائط',
    bulkUpload: 'تحميل بالجملة',
    crop: 'محصول',
    cropToolDescription: 'اسحب الزوايا المحددة للمنطقة، رسم منطقة جديدة أو قم بضبط القيم أدناه.',
    download: 'تحميل',
    dragAndDrop: 'اسحب وأفلت الوسائط',
    dragAndDropHere: 'أو اسحب وأفلت الوسائط هنا',
    editImage: 'تعديل الصورة',
    fileName: 'اسم الملفّ',
    fileSize: 'حجم الملفّ',
    filesToUpload: 'وسائط للرفع',
    fileToUpload: 'وسائط للرفع',
