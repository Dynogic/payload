...
export const heTranslations: DefaultTranslationsObject = {
  ...
  general: {
    ...
    updating: 'מעדכן',
    uploading: 'מעלה ({{progress}}%)',
    uploadingBulk: 'מעלה {{current}} מתוך {{total}} ({{progress}}%)',
    user: 'משתמש',
    username: 'שם משתמש',
    users: 'משתמשים',
    value: 'ערך',
  ...
  upload: {
    ...
    download: 'הורדה',
    dragAndDrop: 'גרור ושחרר מדיה',
    dragAndDropHere: 'או גרור ושחרר מדיה כאן',
    editImage: 'ערוך תמונה',
    fileName: 'שם קובץ',
    fileSize: 'גודל קובץ',
    filesToUpload: 'מדיה להעלאה',
    fileToUpload: 'מדיה להעלאה',
