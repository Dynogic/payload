...
export const etTranslations: DefaultTranslationsObject = {
  ...
  folder: {
    assign: 'Määra',
    assignFolder: 'Määra kaust',
    assigning: 'Määramine...',
    assignItemsToFolderConfirmation:
      'Olete määramas <1>{{count}} {{label}}</1> kausta <2>{{toFolder}}</2>. Kas olete kindel?',
    assignItemsToRootConfirmation:
      'Olete eemaldamas <1>{{count}} {{label}}</1> nende praegusest kaustast. Kas olete kindel?',
    ...
    itemsAssignedToFolder: '{{title}} määratud kausta {{folderName}}',
    itemsMovedToFolder: '{{title}} viidi üle kausta {{folderName}}',
    itemsMovedToRoot: '{{title}} on teisaldatud juurkausta.',
    itemsRemovedFromFolder: '{{title}} eemaldatud kaustast',
  ...
  general: {
    ...
    updating: 'Uuendamine',
    uploading: 'Üleslaadimine ({{progress}}%)',
    uploadingBulk: 'Üleslaadimine {{current}} / {{total}} ({{progress}}%)',
    user: 'Kasutaja',
    username: 'Kasutajanimi',
    users: 'Kasutajad',
    value: 'Väärtus',
  ...
  upload: {
    addFile: 'Lisa meediat',
    addFiles: 'Lisa meediat',
    ...
    dragAndDrop: 'Lohista meediat',
    dragAndDropHere: 'või lohista meediat siia',
    editImage: 'Muuda pilti',
    fileName: 'Failinimi',
    fileSize: 'Failisuurus',
    filesToUpload: 'Meediat üleslaadimiseks',
    fileToUpload: 'Meediat üleslaadimiseks',
