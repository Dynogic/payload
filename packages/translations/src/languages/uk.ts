...
export const ukTranslations: DefaultTranslationsObject = {
  ...
  general: {
    ...
    uploadingBulk: 'Завантаження {{current}} з {{total}} ({{progress}}%)',
    user: 'Користувач',
    username: "Ім'я користувача",
    users: 'Користувачі',
    value: 'Значення',
  ...
  upload: {
    addFile: 'Додати медіа',
    addFiles: 'Додати медіа',
    bulkUpload: 'Масове завантаження',
    crop: 'Обрізати',
    cropToolDescription:
      'Перетягніть кути обраної області, намалюйте нову область або скоригуйте значення нижче.',
    download: 'Завантажити',
    dragAndDrop: 'Перетягніть медіафайл',
    dragAndDropHere: 'або перетягніть медіафайл сюди',
    editImage: 'Редагувати зображення',
    fileName: 'Назва файлу',
    fileSize: 'Розмір файлу',
    filesToUpload: 'Медіа для завантаження',
    fileToUpload: 'Медіа для завантаження',
