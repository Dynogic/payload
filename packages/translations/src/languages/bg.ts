...
export const bgTranslations: DefaultTranslationsObject = {
  ...
  upload: {
    addFile: 'Добавяне на медия',
    addFiles: 'Добавяне на медия',
    bulkUpload: 'Масово Качване',
    crop: 'Изрязване',
    cropToolDescription:
      'Плъзни ъглите на избраната област, избери нова област или коригирай стойностите по-долу.',
    download: 'Изтегляне',
    dragAndDrop: 'Плъзни и пусни медия',
    dragAndDropHere: 'или плъзни и пусни медия тук',
    editImage: 'Редактирай изображение',
    fileName: 'Име на файла',
    fileSize: 'Големина на файла',
    filesToUpload: 'Медия за качване',
    fileToUpload: 'Медия за качване',
