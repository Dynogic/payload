...
export const zhTwTranslations: DefaultTranslationsObject = {
  ...
  folder: {
    ...
    assignItemsToFolderConfirmation:
      '您即將把 <1>{{count}} {{label}}</1> 指定到 <2>{{toFolder}}</2>。確定嗎？',
    assignItemsToRootConfirmation: '您即將從目前資料夾中移除 <1>{{count}} {{label}}</1>。確定嗎？',
    ...
    itemsAssignedToFolder: '{{title}} 已指定到 {{folderName}}',
    itemsMovedToFolder: '{{title}} 已移至 {{folderName}}',
    itemsMovedToRoot: '{{title}} 已移至根資料夾',
    itemsRemovedFromFolder: '{{title}} 已從資料夾中移除',
    moveFolder: '移動資料夾',
  ...
  general: {
    ...
    uploadingBulk: '正在上傳 {{current}} / {{total}} ({{progress}}%)',
    user: '使用者',
    username: '使用者名稱',
    users: '使用者',
    value: '值',
  ...
  upload: {
    ...
    download: '下載',
    dragAndDrop: '拖放媒體檔案',
    dragAndDropHere: '或將媒體檔案拖放至此',
    editImage: '編輯圖片',
    fileName: '檔案名稱',
    fileSize: '檔案大小',
    filesToUpload: '要上傳的媒體',
    fileToUpload: '要上傳的媒體',
    focalPoint: '對焦點',
