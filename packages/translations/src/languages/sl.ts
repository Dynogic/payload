...
export const slTranslations: DefaultTranslationsObject = {
  ...
  general: {
    ...
    uploading: 'Nalaganje ({{progress}}%)',
    uploadingBulk: 'Nalaganje {{current}} od {{total}} ({{progress}}%)',
    user: 'Uporabnik',
    username: 'Uporabniško ime',
    users: 'Uporabniki',
    value: 'Vrednost',
  ...
  upload: {
    addFile: 'Dodaj medij',
    addFiles: 'Dodaj medij',
    bulkUpload: 'Množično nalaganje',
    crop: 'Obreži',
    cropToolDescription:
      'Povlecite kote izbranega območja, narišite novo območje ali prilagodite vrednosti spodaj.',
    download: 'Prenos',
    dragAndDrop: 'Povleci in spusti medij',
    dragAndDropHere: 'ali povleci in spusti medij sem',
    editImage: 'Uredi sliko',
    fileName: 'Ime datoteke',
    fileSize: 'Velikost datoteke',
    filesToUpload: 'Mediji za nalaganje',
    fileToUpload: 'Mediji za nalaganje',
    focalPoint: 'Žarišče',
