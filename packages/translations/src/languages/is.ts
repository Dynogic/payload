...
export const isTranslations: DefaultTranslationsObject = {
  ...
  folder: {
    assign: 'Úthluta',
    assignFolder: 'Úthluta möppu',
    assigning: 'Úthluta...',
    assignItemsToFolderConfirmation:
      'Þú ert að fara að úthluta <1>{{count}} {{label}}</1> í <2>{{toFolder}}</2>. Ertu viss?',
    assignItemsToRootConfirmation:
      'Þú ert að fara að fjarlægja <1>{{count}} {{label}}</1> úr núverandi möppu þeirra. Ertu viss?',
    ...
    itemsAssignedToFolder: '{{title}} úthlutað í {{folderName}}',
    itemsMovedToFolder: '{{title}} færð í {{folderName}}',
    itemsMovedToRoot: '{{title}} færð í rótarmöppuna',
    itemsRemovedFromFolder: '{{title}} fjarlægt úr möppu',
  ...
  general: {
    ...
    updating: 'Uppfæri',
    uploading: 'Hleð upp ({{progress}}%)',
    uploadingBulk: 'Hleð upp {{current}} af {{total}} ({{progress}}%)',
    user: 'Notandi',
    username: 'Notandanafn',
    users: 'Notendur',
    value: 'Gildi',
  ...
  upload: {
    addFile: 'Bæta við miðli',
    addFiles: 'Bæta við miðli',
    bulkUpload: 'Magn upphal',
    crop: 'Skera',
    cropToolDescription:
      'Dragðu horn valda svæðisins, teiknaðu nýtt svæði eða stilltu gildin hér að neðan.',
    download: 'Sækja',
    dragAndDrop: 'Dragðu og slepptu miðli',
    dragAndDropHere: 'eða dragðu og slepptu miðli hér',
    editImage: 'Breyta mynd',
    fileName: 'Skráarnafn',
    fileSize: 'Skráarstærð',
    filesToUpload: 'Miðlar til að hlaða upp',
    fileToUpload: 'Miðlar til að hlaða upp',
