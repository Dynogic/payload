...
export const viTranslations: DefaultTranslationsObject = {
  ...
  folder: {
    ...
    assignItemsToFolderConfirmation:
      'Bạn sắp gán <1>{{count}} {{label}}</1> vào <2>{{toFolder}}</2>. Bạn có chắc không?',
    assignItemsToRootConfirmation:
      'Bạn sắp xóa <1>{{count}} {{label}}</1> khỏi thư mục hiện tại. Bạn có chắc không?',
  ...
  general: {
    ...
    uploadingBulk: 'Đang tải lên {{current}} trong tổng số {{total}} ({{progress}}%)',
    user: 'Người dùng',
    username: 'Tên đăng nhập',
    users: 'Người dùng',
    value: 'Giá trị',
  ...
  upload: {
    addFile: 'Thêm phương tiện',
    addFiles: 'Thêm phương tiện',
    bulkUpload: 'Tải lên số lượng lớn',
    crop: 'Cắt xén',
    cropToolDescription:
      'Kéo các góc của khu vực đã chọn, vẽ một khu vực mới hoặc điều chỉnh các giá trị dưới đây.',
    download: 'Tải xuống',
    dragAndDrop: 'Kéo và thả phương tiện',
    dragAndDropHere: 'hoặc kéo và thả phương tiện vào đây',
    editImage: 'Chỉnh sửa hình ảnh',
    fileName: 'Tên file',
    fileSize: 'Dung lượng file',
    filesToUpload: 'Phương tiện để tải lên',
    fileToUpload: 'Phương tiện để tải lên',
