...
export const plTranslations: DefaultTranslationsObject = {
  ...
  general: {
    ...
    uploadingBulk: 'Przesyłanie {{current}} z {{total}} ({{progress}}%)',
    user: 'użytkownik',
    username: 'Nazwa użytkownika',
    users: 'użytkownicy',
    value: 'Wartość',
  ...
  upload: {
    addFile: 'Dodaj media',
    addFiles: 'Dodaj media',
    bulkUpload: 'Załaduj masowo',
    crop: 'Przytnij',
    cropToolDescription:
      'Przeciągnij narożniki wybranego obszaru, narysuj nowy obszar lub dostosuj poniższe wartości.',
    download: 'Pobierz',
    dragAndDrop: 'Przeciągnij i upuść media',
    dragAndDropHere: 'lub przeciągnij i upuść media tutaj',
    editImage: 'Edytuj obraz',
    fileName: 'Nazwa pliku',
    fileSize: 'Rozmiar pliku',
    filesToUpload: 'Media do przesłania',
    fileToUpload: 'Media do przesłania',
