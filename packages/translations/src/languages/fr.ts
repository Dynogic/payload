...
export const frTranslations: DefaultTranslationsObject = {
  ...
  upload: {
    addFile: 'Ajouter des médias',
    addFiles: 'Ajouter des médias',
    ...
    dragAndDrop: 'Glisser-déposer des médias',
    dragAndDropHere: 'ou glisser-déposer des médias ici',
    editImage: 'Modifier l’image',
    fileName: 'Nom du fichier',
    fileSize: 'Taille du fichier',
    filesToUpload: 'Médias à télécharger',
    fileToUpload: 'Médias à télécharger',
    ...
    selectFile: 'Sélectionner des médias',
