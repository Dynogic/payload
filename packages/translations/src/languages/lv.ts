...
export const lvTranslations: DefaultTranslationsObject = {
  ...
  upload: {
    addFile: 'Pievienot multividi',
    addFiles: 'Pievienot multividi',
    ...
    dragAndDrop: 'Velciet un nometiet multividi',
    dragAndDropHere: 'vai velciet un nometiet multividi šeit',
    editImage: 'Rediģēt attēlu',
    fileName: 'Faila nosaukums',
    fileSize: 'Faila izmērs',
    filesToUpload: 'Multivide augšupielādei',
    fileToUpload: 'Multivide augšupielādei',
