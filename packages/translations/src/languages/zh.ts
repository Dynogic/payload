...
export const zhTranslations: DefaultTranslationsObject = {
  ...
  folder: {
    ...
    assignItemsToFolderConfirmation:
      '您即将把 <1>{{count}} {{label}}</1> 分配到 <2>{{toFolder}}</2>。确定吗？',
    assignItemsToRootConfirmation: '您即将从当前文件夹中移除 <1>{{count}} {{label}}</1>。确定吗？',
    ...
    itemsAssignedToFolder: '{{title}} 已分配到 {{folderName}}',
    itemsMovedToFolder: '{{title}} 已被移至 {{folderName}}',
    itemsMovedToRoot: '{{title}} 已被移至根文件夹',
    itemsRemovedFromFolder: '{{title}} 已从文件夹中移除',
    moveFolder: '移动文件夹',
  ...
  general: {
    ...
    uploadingBulk: '正在上传 {{current}} / {{total}} ({{progress}}%)',
    user: '用户',
    username: '用户名',
    users: '用户',
    value: '值',
  ...
  upload: {
    ...
    download: '下载',
    dragAndDrop: '拖放媒体文件',
    dragAndDropHere: '或将媒体文件拖放到此处',
    editImage: '编辑图像',
    fileName: '文件名',
    fileSize: '文件大小',
    filesToUpload: '要上传的媒体',
    fileToUpload: '要上传的媒体',
    focalPoint: '焦点',
