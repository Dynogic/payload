...
export const deTranslations: DefaultTranslationsObject = {
  ...
  general: {
    ...
    uploadingBulk: 'Hochladen von {{current}} von {{total}} ({{progress}}%)',
    user: 'Benutzer',
    username: 'Benutzername',
    users: 'Benutzer',
    value: 'Wert',
  ...
  upload: {
    addFile: 'Medien hinzufügen',
    addFiles: 'Medien hinzufügen',
    ...
    dragAndDrop: 'Medien hierher ziehen',
    dragAndDropHere: 'oder Medien hier ablegen',
    editImage: 'Bild bearbeiten',
    fileName: 'Dateiname',
    fileSize: 'Dateigröße',
    filesToUpload: 'Medien zum Hochladen',
    fileToUpload: 'Medien zum Hochladen',
