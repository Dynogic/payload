...
export const itTranslations: DefaultTranslationsObject = {
  ...
  general: {
    ...
    uploadingBulk: 'Caricamento {{current}} di {{total}} ({{progress}}%)',
    user: 'Utente',
    username: 'Nome utente',
    users: 'Utenti',
    value: 'Valore',
  ...
  upload: {
    addFile: 'Aggiungi media',
    addFiles: 'Aggiungi media',
    ...
    download: 'Scarica',
    dragAndDrop: 'Trascina e rilascia media',
    dragAndDropHere: 'o trascina e rilascia media qui',
    editImage: 'Modifica immagine',
    fileName: 'Nome File',
    fileSize: 'Dimensione File',
    filesToUpload: 'Media da caricare',
    fileToUpload: 'Media da caricare',
