...
export const azTranslations: DefaultTranslationsObject = {
  ...
  general: {
    ...
    uploadingBulk: '{{total}}-dan {{current}}-un yüklənməsi ({{progress}}%)',
    user: 'İstifadəçi',
    username: 'İstifadəçi adı',
    users: 'İstifadəçilər',
    value: 'Dəyər',
  ...
  upload: {
    addFile: 'Media əlavə et',
    addFiles: 'Media əlavə et',
    bulkUpload: 'Kütləvi Yükləmə',
    crop: 'Məhsul',
    cropToolDescription:
      'Seçilmiş sahənin köşələrini sürükləyin, yeni bir sahə çəkin və ya aşağıdakı dəyərləri düzəltin.',
    download: 'Yükləyin',
    dragAndDrop: 'Medianı sürükləyib buraxın',
    dragAndDropHere: 'və ya medianı buraya sürükləyib buraxın',
    editImage: 'Şəkili Redaktə Et',
    fileName: 'Faylın Adı',
    fileSize: 'Faylım Ölçüsü',
    filesToUpload: 'Yüklenecek media',
    fileToUpload: 'Yüklenecek media',
