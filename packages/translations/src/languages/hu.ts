...
export const huTranslations: DefaultTranslationsObject = {
  ...
  general: {
    ...
    updating: 'Frissítés',
    uploading: 'Feltöltés ({{progress}}%)',
    uploadingBulk: 'Feltöltés: {{current}} / {{total}} ({{progress}}%)',
    user: 'Felhasználó',
    username: 'Felhasználónév',
    users: 'Felhasználók',
    value: 'Érték',
  ...
  upload: {
    addFile: 'Média hozzáadása',
    addFiles: 'Média hozzáadása',
    ...
    download: 'Letöltés',
    dragAndDrop: 'Húzzon ide médiafájlt',
    dragAndDropHere: 'vagy húzzon ide médiafájlt',
    editImage: 'Kép szerkesztése',
    fileName: 'Fájlnév',
    fileSize: 'Fájl mérete',
    filesToUpload: 'Média feltöltéshez',
    fileToUpload: 'Média feltöltéshez',
    ...
    selectFile: 'Médiafájl kiválasztása',
  ...
  validation: {
    ...
    invalidBlocks:
      'Ez a mező olyan blokkokat tartalmaz, amelyek már nem megengedettek: {{blocks}}.',
