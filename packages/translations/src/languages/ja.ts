...
export const jaTranslations: DefaultTranslationsObject = {
  ...
  error: {
    ...
    revertingDocument: 'ドキュメントを元に戻す際に問題が発生しました。',
  ...
  general: {
    ...
    uploadingBulk: '{{current}} / {{total}} をアップロード中 ({{progress}}%)',
    user: 'ユーザー',
    username: 'ユーザー名',
    users: 'ユーザー',
    value: '値',
  ...
  upload: {
    ...
    download: 'ダウンロード',
    dragAndDrop: 'メディアをドラッグ＆ドロップ',
    dragAndDropHere: 'またはメディアをここにドラッグ＆ドロップ',
    editImage: '画像を編集する',
    fileName: 'ファイル名',
    fileSize: 'ファイル容量',
    filesToUpload: 'アップロードするメディア',
    fileToUpload: 'アップロードするメディア',
    focalPoint: '焦点',
  ...
  version: {
    ...
    unpublish: '非公開',
    unpublished: '非公開',
    unpublishedSuccessfully: '正常に非公開になりました。',
