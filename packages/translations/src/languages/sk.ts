...
export const skTranslations: DefaultTranslationsObject = {
  ...
  upload: {
    addFile: 'Pridať médiá',
    addFiles: 'Pridať médiá',
    bulkUpload: 'Hromadné nahranie',
    crop: 'Orezať',
    cropToolDescription:
      'Potiahnite rohy vybranej oblasti, nakreslite novú oblasť alebo upravte hodnoty nižšie.',
    download: 'Stiahnuť',
    dragAndDrop: 'Presuňte médium',
    dragAndDropHere: 'alebo presuňte médium sem',
    editImage: 'Upraviť obrázok',
    fileName: 'Názov súboru',
    fileSize: 'Veľkosť súboru',
    filesToUpload: 'Médiá na nahratie',
    fileToUpload: 'Médiá na nahratie',
