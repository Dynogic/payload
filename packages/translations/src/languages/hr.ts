...
export const hrTranslations: DefaultTranslationsObject = {
  ...
  upload: {
    ...
    download: 'Preuzmi',
    dragAndDrop: 'Povuci i ispusti medij',
    dragAndDropHere: 'ili povuci i ispusti medij ovdje',
    editImage: 'Uredi sliku',
    fileName: 'Ime datoteke',
    fileSize: 'Veličina datoteke',
    filesToUpload: 'Medij za prijenos',
    fileToUpload: 'Medij za prijenos',
