...
export const koTranslations: DefaultTranslationsObject = {
  ...
  folder: {
    ...
    assignItemsToFolderConfirmation:
      '<1>{{count}} {{label}}</1>을(를) <2>{{toFolder}}</2>에 할당하려고 합니다. 계속하시겠습니까?',
    assignItemsToRootConfirmation:
      '<1>{{count}} {{label}}</1>을(를) 현재 폴더에서 제거하려고 합니다. 계속하시겠습니까?',
    ...
    itemsAssignedToFolder: '{{title}}이(가) {{folderName}}에 할당되었습니다',
    itemsMovedToFolder: '{{title}}이(가) {{folderName}}로 이동되었습니다.',
    itemsMovedToRoot: '{{title}}이(가) 루트 폴더로 이동되었습니다.',
    itemsRemovedFromFolder: '{{title}}이(가) 폴더에서 제거되었습니다',
    moveFolder: '폴더 이동',
  ...
  general: {
    ...
    uploadingBulk: '{{current}} / {{total}} 업로드 중 ({{progress}}%)',
    user: '사용자',
    username: '사용자 이름',
    users: '사용자',
    value: '값',
  ...
  upload: {
    ...
    download: '다운로드',
    dragAndDrop: '미디어를 드래그 앤 드롭',
    dragAndDropHere: '또는 미디어를 여기로 드래그 앤 드롭',
    editImage: '이미지 수정',
    fileName: '파일 이름',
    fileSize: '파일 크기',
    filesToUpload: '업로드할 미디어',
    fileToUpload: '업로드할 미디어',
    focalPoint: '초점',
  ...
  validation: {
    ...
    invalidBlock: '"{{block}}" 블록은 허용되지 않습니다.',
    invalidBlocks: '이 필드는 더 이상 허용되지 않는 블록을 포함하고 있습니다: {{blocks}}.',
    ...
    latitudeOutOfBounds: '위도는 -90과 90 사이여야 합니다.',
