...
export const hyTranslations: DefaultTranslationsObject = {
  ...
  general: {
    ...
    updateForEveryone: '',
    updating: 'Թարմացում',
    uploading: 'Վերբեռնվում է ({{progress}}%)',
    uploadingBulk: 'Վերբեռնվում է {{current}}-ը {{total}}-ից ({{progress}}%)',
    user: 'Օգտատեր',
    username: 'Օգտանուն',
    users: 'Օգտատերեր',
    value: 'Արժեք',
  ...
  upload: {
    addFile: 'Ավելացնել մեդիա',
    addFiles: 'Ավելացնել մեդիա',
    bulkUpload: 'Զանգվածային վերբեռնում',
    crop: 'Կտրել',
    cropToolDescription:
      'Քաշեք ընտրված տարածքի անկյունները, նշեք նոր տարածք կամ կարգավորեք ստորև նշված արժեքները։',
    download: 'Ներբեռնել',
    dragAndDrop: 'Քաշել և բաց թողնել մեդիա',
    dragAndDropHere: 'կամ քաշել և բաց թողնել մեդիա այստեղ',
    editImage: 'Խմբագրել պատկերը',
    fileName: 'Ֆայլի անուն',
    fileSize: 'Ֆայլի չափ',
    filesToUpload: 'Մեդիա վերբեռնելու համար',
    fileToUpload: 'Մեդիա վերբեռնելու համար',
    focalPoint: 'Կիզակետ',
